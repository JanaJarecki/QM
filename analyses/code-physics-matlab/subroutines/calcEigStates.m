...
function [eigVals eigVecs]=calcEigStates(xArray,potential,kinematicFactor, higherOrderBoolean)
        ...
        kineticMatrixNew=kineticMatrix*kinematicFactor/spaceStep^2;
        ...
        % find eigen vectors and values of Hamilton-matrix
        [eigVecs, eigValMatrix] = eig(kineticMatrixNew);
        eigVals=diag(eigValMatrix);
        
        eigVecs = 1/sqrt(spaceStep)*eigVecs; % normalize eigen vectors
    end
